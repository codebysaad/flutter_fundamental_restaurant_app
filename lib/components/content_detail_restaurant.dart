    ...
    return Consumer<DbProvider>(
      builder: (_, providerFavorite, __) {
        return FutureBuilder(
          future: providerFavorite.isFavourite(restaurant.id),
          builder: (_, snapshot) {
            ...
            return Scaffold(
              ...
              floatingActionButton: isFavourite
                  ? FloatingActionButton(
                      ...
                      onPressed: () {
                        providerFavorite.deleteFavourite(restaurant.id);
                  ...
                  : FloatingActionButton(
                      backgroundColor: Colors.blueAccent.withOpacity(0.6),
                      onPressed: () {
                        providerFavorite.insertFavourite(
                          Restaurant(
                            id: restaurant.id,
              ...
              body: Material(
                child: SingleChildScrollView(
                  key: const Key('detailRestaurantScrollView'),
                  child: Column(
                    children: [
                      Hero(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView(
                                ...
                                children: restaurant.categories.map(
                                  (category) {
                                    return Container(
